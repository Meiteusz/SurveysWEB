...
<asp:Content ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="container">
        <div>
            <h2 style="margin-left: 38%;">Sign-up</h2>
        </div>
        <div>
        ...
        <div>
            <input id="txtPassword" type="password" runat="server" placeholder="Enter Password" style="margin-block: 15px; width: 350px; height: 35px; font-size: 20px; border-color: black; border-style: solid; border-radius: 5px; border-width: 1px" />
        </div>
        <div>
